...
import manager.CodeFile
import java.io.BufferedInputStream
import java.io.File
import java.io.FileInputStream

class Tokenizer(var code:String){//filePath: String
    ...
    private fun fetchTokenBody(singleOperator: Boolean=false):Token?{
        ...
        while(true) {
            ...
            if (op!=null){
                ...
                if(singleOperator){index++;return token}
                break
            }
            if(c=='\''){//单引号的字符串
