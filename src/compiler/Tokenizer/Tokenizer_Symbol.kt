...
object Operator_Symbol{
    var op_list=arrayOf(
        op_add,op_minus,op_mutil,op_division,op_mod,op_inc,op_dec,op_assign,op_rightAssign,op_equal,op_notEqual,
        op_left,op_right,op_comma,op_dot,op_dotdot,op_and,op_andAnd,op_or,op_orOr,op_less,op_greater,op_lessEqual,op_greaterEqual,
        op_question,op_bit,op_at,op_pound,op_excl,op_colon,op_backslash,op_bigbracket1,op_bigbracket2,op_bracket1,op_bracket2,op_tinybracket1,op_tinybracket2
    )
